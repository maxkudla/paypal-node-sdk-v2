...
function webhookEvent() {
    ...
    var ret = {
        ...
        simulate: async function resend(data, config) {
            return await api.executeAsync('POST', '/v1/notifications/simulate-event', data, config);
        },
    };
    ret = generate.mixin(ret, operations);
    return ret;
 ...
 * Listing available event types for webhooks
 */
function webhookLookup() {
    var baseURL = '/v1/notifications/webhooks-lookup';
    var operations = ["create", "list", "get", "delete"];
