...
function order() {
    ...
    var operations = ['get', 'capture', "create", "update"];
    ...
    var ret = {
        ...
        "confirmPaymentSource": async function authorize(id, data, config) {
            return await api.executeAsync('POST', this.baseURL + id + '/confirm-payment-source', data, config);
        },
    };
